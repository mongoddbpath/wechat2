                        ...
                        <div class="layui-card-body layui-table-body layui-table-main">
                          ...
                          <script type="text/html" id="currentTableBar">
                            <?php if($user_auth['Item']['edit']){ ?>
                              <a class="layui-btn layui-btn-xs data-count-edit" onclick="xadmin.open('编辑工程项目','<?php echo U('Item/edit');?>?item_id={{d.item_id}}',800,600)" href="javascript:;">编辑</a>
                            <?php } ?>
                            <?php if($user_auth['Item']['delete']){ ?> 
                          ...
                          <script type="text/html" id="showUserTpl">
                            <?php if($user_auth['Item']['item_user']){ ?>
                              <a onclick="xadmin.open('人员列表','<?php echo U('Item/item_user');?>?item_id={{d.item_id}}',1000,600)" href="javascript:;" style="color:blue">查看</a>
                            <?php }else{ ?>
                              <span>无权限查看人员</span>
                            <?php } ?>
                          </script>
    ...
    <script>
      layui.use(['laydate','form','table'], function(){
        ...
        window.delAll = function(argument) {
          var url = '<?php echo U("Item/delete");?>';
